...
<div class="container">
  ...
  <div class="row main-content bg-success text-center">
    ...
    <div class="col-md-8 col-xs-12 col-sm-12 login_form ">
      <div class="container-fluid">
        <div class="row p-3">
          <h2 class="w-75 mx-auto">Log In</h2>
        </div>
        <div class="row">
          <Form @submit="handleLogin" :validation-schema="schema" class="w-75 mx-auto">
        ...
        <div class="row">
          <p>Don't have an account? <router-link to="register"><a>Register Here</a></router-link></p>
        </div>
      </div>
    </div>
  </div>
